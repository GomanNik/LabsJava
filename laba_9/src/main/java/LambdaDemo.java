...
public class LambdaDemo {
    ...
    public static final Function<String, Integer> countWords = s -> s.isEmpty() ? 0 : s.split(",").length;
    ...
    public static final Function<Human, String> getFullName = h -> String.format("%s %s %s",h.getLastName(),h.getFirstName(),h.getSurname());
